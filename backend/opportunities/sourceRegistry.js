...
const JOB_SOURCE_REGISTRY = [
  ...
  },
  {
    ...
    tier: 'remote_primary',
    fit: ['remote', 'writing', 'design', 'developer', 'customer service'],
  },
  {
    id: 'jobicy',
  ...
  },
  {
    ...
    tier: 'remote_primary',
    fit: ['remote', 'AI', 'research', 'developer', 'design'],
  },
  {
    id: 'indeed',
    label: 'Indeed Hungary',
    url: 'https://hu.indeed.com/',
    domains: ['indeed.com', 'hu.indeed.com'],
    tier: 'aggregator',
    fit: ['Hungary', 'Budapest', 'part-time', 'student', 'research'],
  },
];
